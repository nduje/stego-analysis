...
Run (from the repo root):
    python -m scripts.measure.measure_imperceptibility --covers data/alaska/covers --workers 16
    python -m scripts.measure.measure_imperceptibility --limit 20        # quick smoke
"""
import argparse
import base64
import csv
...
def main():
    ...
    ap.add_argument("--out", default="results/csv/imperceptibility.csv")
    ap.add_argument("--summary", default="results/csv/imperceptibility_summary.csv")
