...
Outputs (config x rate x eval_set), directly comparable to the baseline:
  results/csv/chisquare_reanalysis.csv, rs_reanalysis.csv, spa_reanalysis.csv
  results/csv/chisquare_positional_reanalysis.csv  (baseline vs p1 vs all, a few images)

Run (from the repo root):
    python -m scripts.measure.run_attacks_reanalysis
    python -m scripts.measure.run_attacks_reanalysis --limit 20   # smoke
"""
import argparse
import csv
import glob
...
from scripts.data.make_stego_sets import CONFIGS, KEY, make_payload
