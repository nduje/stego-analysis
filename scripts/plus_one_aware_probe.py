...
simple structural statistic -- the honest negative result of Day 19b.

Output: results/plus_one_aware_probe.csv (statistic x alpha x target x AUC).

Run (from the repo root):
    python -m scripts.plus_one_aware_probe --limit 100
"""
import argparse
import csv
import glob
...
def main():
    ...
    ap.add_argument("--out", default="results/plus_one_aware_probe.csv")
