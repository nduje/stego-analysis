...
Same attack logic and harness as Day 6-8 / Day 16 -- only the target changes. For
...
Run (from the repo root):
    python -m scripts.run_attacks_reference --octave <octave-cli>
    python -m scripts.run_attacks_reference --methods lsbr --octave <octave-cli>  # control first
"""
import argparse
import glob
import os
...
from scripts.run_attacks_reanalysis import CHAN, ATTACKS, _score, _blank, _load_split, _r6, _write
from scripts.make_reference_sets import generate
