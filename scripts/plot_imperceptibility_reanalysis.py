...
Reads results/imperceptibility_summary.csv (baseline, E1) and
results/imperceptibility_reanalysis.csv (the 4 configs); writes to results/figures/:
...
Run (from the repo root):
    python -m scripts.plot_imperceptibility_reanalysis
"""
import argparse
import csv
import os
...
def main():
    ...
    ap.add_argument("--reanalysis", default="results/imperceptibility_reanalysis.csv")
