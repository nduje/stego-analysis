...
Run (from the repo root):
    python -m scripts.verify_dataset --covers data/alaska/covers --n 20 --seed 42
"""
import argparse
import glob
import os
...
def verify(covers_dir, n, seed):
    ...
    for path in sample:
        ...
        alg.hide(TEST_MESSAGE, path, "results/_verify_stego.png", passphrase=PASSPHRASE)
        recovered = alg.expose(load_image("results/_verify_stego.png"), passphrase=PASSPHRASE)
