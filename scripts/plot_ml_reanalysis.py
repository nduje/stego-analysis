"""Before/after figures for the ML re-analysis (Day 17) + the full-spectrum summary.

Reads the Day-10 baseline summaries and the Day-17 re-analysis CSVs; writes to
results/figures/:
...
Run (from the repo root):
    python -m scripts.plot_ml_reanalysis
"""
import argparse
import csv
import os
