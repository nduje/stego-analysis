...
Reads results/chisquare_summary.csv, results/chisquare_scores.csv and
results/chisquare_positional.csv; writes to results/figures/:
...
Run (from the repo root):
    python -m scripts.plot_chisquare
"""
import argparse
import csv
import os
...
def main():
    ...
    ap.add_argument("--summary", default="results/chisquare_summary.csv")
    ap.add_argument("--scores", default="results/chisquare_scores.csv")
    ap.add_argument("--positional", default="results/chisquare_positional.csv")
