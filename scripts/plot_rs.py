...
Reads results/rs_summary.csv (and, if present, results/chisquare_summary.csv for
...
def main():
    ...
    ap.add_argument("--summary", default="results/rs_summary.csv")
    ap.add_argument("--scores", default="results/rs_scores.csv")
    ap.add_argument("--chisquare", default="results/chisquare_summary.csv")
