"""Generate the final (print) figures -- Day 21. Full-page spec only, SVG + 1200-DPI PNG.

Every number comes from results/master_matrix.csv, except a few figures that need data
...
(ml_group_reanalysis.csv). Style/colours/labels come from scripts.style.

Run (from the repo root):
    python -m scripts.make_final_figures
    python -m scripts.make_final_figures --only ml_pe_vs_rate
"""
import argparse
import csv
import os
