...
Reads results/csv/spa_summary.csv (and results/csv/rs_summary.csv for the comparison);
...
Run (from the repo root):
    python -m scripts.report.plot_spa
"""
import argparse
import csv
import os
...
def main():
    ...
    ap.add_argument("--rs", default="results/csv/rs_summary.csv")
