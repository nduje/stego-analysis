...
normalises the version column (config / method -> version), and writes:
  ...
  results/csv/master_matrix.csv  -- tidy: version, family, rate, attack, metric, value, eval_set
  results/csv/main_table.csv     -- wide pivot at rate=1.0 (9 versions x the headline columns)
...
Run (from the repo root):
    python -m scripts.report.build_matrix
"""
import csv
import os
