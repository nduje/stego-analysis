"""Central Day-20 figure: full-spectrum detectability, all versions x all attacks.

Reads results/master_matrix.csv (source of truth) and draws P_E vs rate as a 5-panel
...
def main():
    ...
    ap.add_argument("--matrix", default="results/master_matrix.csv")
    ap.add_argument("--out", default="results/figures/all_attacks_comparison_full.png")
    args = ap.parse_args()
